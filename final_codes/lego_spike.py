    ...
    if col_1 == 'plateado' or col_3 == 'plateado':
        ...
        if col_1 == 'green' or col_3 == 'green':
            ...
            if s == 'F':
                ...
                if luz_3 > 40 and luz_1 > 40 and luz_3 > 40:
                    motor_pair.start_tank(30,30)
                    # PID(0.4, 40)
                elif luz_3 < 29 or luz_1 < 29:
                    # PID(2.9, 20)
                    PID(2.9, 15)
                else:
                    # PID(1.8, 35)
...
while True:
    ...
    if col_1 == 'plateado' or col_3 == 'plateado':
        state = 'rescue'
        motor_pair.move_tank(5, 'cm', 50, 50)
    ...
    if col_1 != 'plateado' and col_3 == 'plateado':
        while col_1 != 'plateado':
            ...
            if col_1 == 'plateado' and col_3 == 'plateado':
                state = 'rescue'
                motor_pair.move_tank(7, 'cm', 50, 50)
                substate = 'looking for green corner'
