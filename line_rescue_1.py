    ...
    if col_1 == 'green' and col_3 == 'green':
        ...
        if col_1 == 'green' and col_3 == 'green':
            ...
            if col_3 == 'green' and not col_1 == 'green':
                ...
                motor_pair.move_tank(5,'cm',50,80)
                giro_90_der()
        ...
        if col_3 == 'green' and col_1 == 'green':
            ...
            if col_1 == 'green' and not col_3 == 'green':
                ...
                # motor_pair.move_tank(0.5,'cm',-80,-80)
                # motor_pair.move_tank(1,'cm',50,50)
                motor_pair.move_tank(5,'cm',80,50)
                giro_90_izq()
                # motor_pair.move_tank(2,'cm',30,30)
                buscar_linea('izq')
...
def bajada():
    ...
    wait_for_seconds(4)
    # print("hola")
    motor_pair.move_tank(8, 'cm', 30, 30)
    wait_for_seconds(1)
    while hub.motion_sensor.get_pitch_angle() < -1:
        update()
        error = luz_1 - luz_3
...
for substates in 'rescue':
    substate = 'looking for the victim'
    substate = 'exploring'
...
while True:
    ...
    if hub.motion_sensor.get_pitch_angle() > 6:
        subida()
    elif hub.motion_sensor.get_pitch_angle() < -4:
        bajada()
    else:
        if col_1 == 'green' or col_3 == 'green':
            motor_pair.start_tank(0,0)
            ...
            if s == 'F':
                motor_pair.start_tank(0,0)
            if s == 'A':
                if luz_3 < 16 or luz_1 < 16:
                    salida = int(2.6 * proporcional + ki * integral + kd * derivada)
                    motor_pair.start_tank(25 + salida,25 - salida)
...
while True:
    ...
    if hub.motion_sensor.get_pitch_angle() > 10 or hub.motion_sensor.get_pitch_angle() < -10:
        salida = int(0.3 * proporcional)
        motor_pair.start_tank(35 + salida,35 - salida)
    else:
        if col_1 == 'green' or col_3 == 'green':
            motor_pair.start_tank(0,0)
            ...
            if luz_3 < 19 or luz_1 < 19:
                salida = int(2.6 * proporcional + ki * integral + kd * derivada)
                motor_pair.start_tank(25 + salida,25 - salida)
            elif luz_3 < 30 or luz_1 < 30:
                salida = int(1.7 * proporcional + ki * integral + kd * derivada)
                motor_pair.start_tank(30 + salida,30 - salida)
            else:
                salida = int(1.1 * proporcional + ki * integral + kd * derivada)
...
while True:
    ...
    if col_1 == 'plateado' or col_3 == 'plateado':
        ...
        if col_1 == 'green' or col_3 == 'green':
            ...
            if hub.motion_sensor.get_pitch_angle() > 10 or hub.motion_sensor.get_pitch_angle() < -10:
                # b.write("Rampa\n")
                salida = int(0.4 * proporcional + ki * integral + kd * derivada)
                motor_pair.start_tank(35 + salida,35 - salida)
            else:
                if luz_3 < 19 or luz_1 < 19:
                    salida = int(2.6 * proporcional + ki * integral + kd * derivada)
